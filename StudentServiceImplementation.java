...
public class StudentServiceImplementation {
	...
	private static File extractFileInformation(Set<Student1> studentSet) throws ParseException {
		File file = new File("/Users/guadalupecatalan/Desktop/testFolder/studentList.txt");
		File myObj = new File("/Users/guadalupecatalan/Desktop/testFolder/studentList.txt");
	...
	// find the avg age of the students
	private static void avgAge(Set<Student1> studentSet) {
		 int average = 0,
			 sum = 0,
			 getAgeCounter = 0;
...
//		 });
		 ...
		 System.out.println("Here is the average age of all the students: " + average);
	}
	...
	private static void showCommands() {
		...
		System.out.println("'average' \nDescription: Shows the average age of all the students\n");
